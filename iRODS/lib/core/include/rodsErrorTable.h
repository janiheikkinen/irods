...
/* GSSEAP error */
/** @defgroup gsseap_errors GSSEAP ERRORs
 *  @ingroup error_codes
 *  ERROR Code Range 2,400,000 to 2,499,000
 * @{
 */
NEW_ERROR(GSSEAP_NOT_COMPILED_IN,                      -2401000);
NEW_ERROR(GSSEAP_NOT_BUILT_INTO_CLIENT,                -2402000);
NEW_ERROR(GSSEAP_NOT_BUILT_INTO_SERVER,                -2403000);
NEW_ERROR(GSSEAP_ERROR_IMPORT_NAME,                    -2404000);
NEW_ERROR(GSSEAP_ERROR_INIT_SECURITY_CONTEXT,          -2405000);
NEW_ERROR(GSSEAP_ERROR_SENDING_TOKEN_LENGTH,           -2406000);
NEW_ERROR(GSSEAP_ERROR_READING_TOKEN_LENGTH,           -2407000);
NEW_ERROR(GSSEAP_ERROR_TOKEN_TOO_LARGE,                -2408000);
NEW_ERROR(GSSEAP_ERROR_BAD_TOKEN_RCVED,                -2409000);
NEW_ERROR(GSSEAP_SOCKET_READ_ERROR,                    -2410000);
NEW_ERROR(GSSEAP_PARTIAL_TOKEN_READ,                   -2411000);
NEW_ERROR(GSSEAP_SOCKET_WRITE_ERROR,                   -2412000);
NEW_ERROR(GSSEAP_ERROR_FROM_GSSEAP_LIBRARY,	       -2413000);
NEW_ERROR(GSSEAP_ERROR_IMPORTING_NAME,                 -2414000);
NEW_ERROR(GSSEAP_ERROR_ACQUIRING_CREDS,                -2415000);
NEW_ERROR(GSSEAP_ACCEPT_SEC_CONTEXT_ERROR,             -2416000);
NEW_ERROR(GSSEAP_ERROR_DISPLAYING_NAME,                -2417000);
NEW_ERROR(GSSEAP_ERROR_RELEASING_NAME,                 -2418000);
NEW_ERROR(GSSEAP_DN_DOES_NOT_MATCH_USER,               -2419000);
NEW_ERROR(GSSEAP_QUERY_INTERNAL_ERROR,                 -2420000);
NEW_ERROR(GSSEAP_NO_MATCHING_DN_FOUND,                 -2421000);
NEW_ERROR(GSSEAP_MULTIPLE_MATCHING_DN_FOUND,           -2422000);
/** @} */
